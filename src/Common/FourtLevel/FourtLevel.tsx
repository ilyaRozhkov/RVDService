            ...
            <div className={'fourthlevel-container bold'}>
                <div className={'fourthlevel-container-left'}>
                    ...
                    <div className={'fourthlevel-container-left-text'}> Мы осуществляем обслуживание и ремонт электрики любой сложности, электронных блоков и датчиков.
                        ...
                        Ремонт блоков ABS ,ЭБУ,автономных отопителей, пневматики и всего, что касается электрики, электронных блоков и датчиков, системы ГУР, систем кондиционировани любых марок, а так же ремонт шлангов компрессоров грузовых авто (Камаз, Маз, MAN, Volvo, DAF, Mercedes, Renault, Shaanxi и др.) </div>
                </div>
                {!mobile &&
                <div className={'fourthlevel-container-right'}>
                    ...
                    <div className={'fourthlevel-container-right-text'}>
                        ...
                        не выполняет полноценно свои функции, а при включении кондиционера возникают посторонние шумы, необходимо записаться на диагностику. Нашим преимуществом является выявление точной причины и ремонт за короткий срок.
                    </div>
                </div>
                }
            </div>
